...
depto_sel = st.multiselect(
    ...
    default=df_pob2['departamento'].unique()
)
...
with col1:
  G_bar=osm.diag_barras_apil(df_mb2_f,'nombre_cat_edad','Total','sexo','Casos por edad',P_Colores)
  st.plotly_chart(G_bar, use_container_width=True)
with col2:
  G_Lineas=osm.diag_lineas(df_mb2_ft,'anio','Total','sexo','Tendencia por años','N. Casos')
